...
Source Server         : _localhost(sssweb2本地)
Source Server Version : 50510
Source Host           : localhost:3306
Source Database       : sssweb2_pub

Target Server Type    : MYSQL
Target Server Version : 50510
File Encoding         : 65001

Date: 2017-06-16 14:07:06
*/
...
-- ----------------------------
INSERT INTO `t_db_info` VALUES ('1', '开发环境_xxx', 'mysql', '127.0.0.1', '3306', 'root', '123456', 'test');
...
-- ----------------------------
INSERT INTO `t_local_project` VALUES ('1', 'workspace_xxx', 'F:\\git\\xxx', '/app/[^/]*\r\n/public/javascripts\r\n/public/stylesheets', '/conf/routes\r\n/conf/messages');
INSERT INTO `t_local_project` VALUES ('2', 'xxx', 'F:\\git\\xxx\\xxx', '/app/[^/]*\r\n/public/javascripts\r\n/public/stylesheets', '/conf/routes\r\n/conf/messages');
...
INSERT INTO `t_params` VALUES ('11', 'git日志查询-本地仓库地址', 'gitLocalPath', '[\"F:\\git\\xxx\"]');
...
INSERT INTO `t_params` VALUES ('21', 'git日志查询-git执行文件地址', 'gitExePath', 'F:\\chengxu\\Git\\bin\\sh.exe');
INSERT INTO `t_params` VALUES ('22', 'git日志查询-忽略的文件名称', 'gitLogIgorName', 'resource.properties,application.conf,kafka.properties,log4j.properties,.gitignore,.project');
INSERT INTO `t_params` VALUES ('23', 'notepad++执行文件地址', 'notepadPath', 'E:\\chengxu\\Notepad++\\notepad++.exe');
INSERT INTO `t_params` VALUES ('24', 'SecureCRT执行文件地址', 'SecureCRTExePath', 'F:\\chengxu\\SecureCRTSecureFX_HH_x86_7.0.0.326\\App\\VanDyke Clients\\SecureCRT.exe');
...
-- ----------------------------
INSERT INTO `t_query_templet` VALUES ('1', 'workspace_xxx', 'F:\\git\\xxx', '/app/.*,/conf/.*,/public/.*,/SQL/.*,/configmodify/.*', '', '.*\\.java,.*\\.conf,.*\\.properties,.*\\.js,.*\\.css,.*\\.xml,.*\\.html,.*\\.txt,.*\\.sql,[^.]*', '', 'utf-8');
INSERT INTO `t_query_templet` VALUES ('2', 'xxx', 'F:\\git\\xxx\\xxx', '/app/.*,/conf/.*,/public/.*,/SQL/.*,/configmodify/.*', null, '.*\\.java,.*\\.conf,.*\\.properties,.*\\.js,.*\\.css,.*\\.xml,.*\\.html,.*\\.txt,.*\\.sql,[^.]*', '', 'utf-8');
...
-- ----------------------------
INSERT INTO `t_redis_info` VALUES ('1', 'test', '127.0.0.1', '6379', 'xxx');
...
CREATE TABLE `t_remote_command` (
  ...
  `name` varchar(255) DEFAULT NULL,
  `command` text,
  `func` varchar(255) DEFAULT NULL COMMENT '业务功能',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;
...
INSERT INTO `t_remote_command` VALUES ('6', '1', 'play-启动项目', 'play start', 'ssh-client,ssh-console');
INSERT INTO `t_remote_command` VALUES ('7', '1', 'play-清理项目', 'play clean', 'ssh-client,ssh-console');
INSERT INTO `t_remote_command` VALUES ('8', '1', 'play-停止项目', 'play stop', 'ssh-client,ssh-console');
INSERT INTO `t_remote_command` VALUES ('9', '1', 'play-查看实时日志', 'tail -n 50 -f logs/application.log', 'ssh-client');
INSERT INTO `t_remote_command` VALUES ('10', '1', 'play-查看最后200行日志', 'tail -n 200 logs/application.log', 'ssh-console');
INSERT INTO `t_remote_command` VALUES ('11', '1', 'play-访问项目', 'curl -m 1  http://{:remoteProject.ip}:{:remoteProject.port}', 'ssh-client,ssh-console');
INSERT INTO `t_remote_command` VALUES ('12', '1', 'play-status', 'play status', 'ssh-client,ssh-console');
...
-- ----------------------------
INSERT INTO `t_remote_project` VALUES ('1', '开发环境', '开发环境_xxx', '192.168.3.39', 'root', '123456', '/home/xxx', '8080', '1', '', 'xxx', '1');
...
INSERT INTO `t_string_handle_templet` VALUES ('11', '替换/变形', '其它-在浏览器打开多个页面', '_newValue:{:stringHandlePubStore.getJSByHrefList(_value)}', '');
