...
import service.back.ParamsBackService;
import service.generate.ParamsGenService;
import utils.JsonUtils;

@Controller
@Scope("prototype")
@RequestMapping("/ParamsBackController")
public class ParamsBackController extends BaseController{
	
	ParamsGenService paramsGenService = new ParamsGenService();
	ParamsBackService paramsBackService = new ParamsBackService();
	
	//返回页面
	@RequestMapping("/page.do")
	public String page(){
		return "back/params.jsp";
	}
	...
	public void search(String params, Integer pageNum, Integer pageSize){
		...
		PageResult<Params> pageResult = paramsBackService.findCollectionByConditionWithPage(paramMap, pageNum, pageSize);
	...
	public void delete(String ids) throws Exception{
		...
		paramsGenService.deleteByIDs(idArr2);
		MessageResult result = new MessageResult(true,"操作成功");
		writeJsonToPage(result);
	}
}