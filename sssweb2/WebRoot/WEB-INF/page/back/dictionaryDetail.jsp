...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/dictionaryDetail.js"></script>
</head>
<body>
					...
					<div class="row">
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_dictionaryId"><span class="title">字典</span></label>
								<div class="col-xs-8">
									<input type="text" name="dictionaryId" id="s_dictionaryId" class="form-control input-sm">
								</div>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_value"><span class="title">字典值</span></label>
								<div class="col-xs-8">
									<input type="text" name="value" id="s_value" class="form-control input-sm">
								</div>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_showText"><span class="title">展示文本</span></label>
								<div class="col-xs-8">
									<input type="text" name="showText" id="s_showText" class="form-control input-sm">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_dictionaryId" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">字典</span></label>
									<div class="col-xs-8">
										<input type="text" name="dictionaryId" id="e_dictionaryId" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_value" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">字典值</span></label>
									<div class="col-xs-8">
										<input type="text" name="value" id="e_value" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_showText" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">展示文本</span></label>
									<div class="col-xs-8">
										<input type="text" name="showText" id="e_showText" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-12">
