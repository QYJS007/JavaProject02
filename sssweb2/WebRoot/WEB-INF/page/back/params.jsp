...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/params.js"></script>
</head>
<body>
					...
					<div class="row">
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_remark"><span class="title">描述</span></label>
								<div class="col-xs-8">
									<input type="text" name="remark" id="s_remark" class="form-control input-sm">
								</div>
							</div>
						</div>
						<div class="col-xs-3">
						...
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_value"><span class="title">值</span></label>
								<div class="col-xs-8">
				...
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_remark" class="col-xs-4 control-label"><span class="title">描述</span></label>
									<div class="col-xs-8">
										<input type="text" name="remark" id="e_remark" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-6">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_value" class="col-xs-2 control-label"><span class="mark">*</span><span class="title">值</span></label>
									<div class="col-xs-10">
										<textarea type="text" name="value" id="e_value" class="form-control input-sm" style="height: 80px;"></textarea>
									</div>
								</div>
							</div>
						</div>
