...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/lineReplaceTemplet.js"></script>
</head>
<body>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">
						<span class="optmark"></span>单行模板替换模板
					</h4>
				</div>
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_oldTemplet" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">旧模板</span></label>
									<div class="col-xs-8">
										<input type="text" name="oldTemplet" id="e_oldTemplet" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_newTemplet" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">新模板</span></label>
									<div class="col-xs-8">
										<input type="text" name="newTemplet" id="e_newTemplet" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_text" class="col-xs-2 control-label"><span class="title">待替换文本示例</span></label>
									<div class="col-xs-10">
										<textarea type="text" name="text" id="e_text" class="form-control input-sm" style="height: 80px;"></textarea>
									</div>
								</div>
							</div>
						</div>
