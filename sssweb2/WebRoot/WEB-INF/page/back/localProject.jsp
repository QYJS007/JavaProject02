...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/localProject.js"></script>
</head>
<body>
				...
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_packDir" class="col-xs-2 control-label"><span class="title">打包文件夹</span></label>
									<div class="col-xs-10">
										<textarea type="text" name="packDir" id="e_packDir" class="form-control input-sm" style="height: 80px;"></textarea>
									</div>
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_packFile" class="col-xs-2 control-label"><span class="title">打包文件</span></label>
									<div class="col-xs-10">
										<textarea type="text" name="packFile" id="e_packFile" class="form-control input-sm" style="height: 80px;"></textarea>
									</div>
								</div>
							</div>
						</div>
