...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/httpTemplet.js"></script>
</head>
<body>
			...
			<div class="panel-body">
				<form id="searchform">
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_url"><span class="title">请求地址</span></label>
								<div class="col-xs-8">
									<input type="text" name="url" id="s_url" class="form-control input-sm">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">
						<span class="optmark"></span>http请求模板
					</h4>
				</div>
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_url" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">请求地址</span></label>
									<div class="col-xs-8">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_method" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">请求方式</span></label>
									<div class="col-xs-8">
										<select class="form-control input-sm" id="e_method" name="method">
			                            </select>
									</div>
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_head" class="col-xs-2 control-label"><span class="title">请求头</span></label>
									<div class="col-xs-10">
										<textarea type="text" name="head" id="e_head" class="form-control input-sm" style="height: 80px;"></textarea>
									</div>
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_param" class="col-xs-2 control-label"><span class="title">请求参数</span></label>
									<div class="col-xs-10">
