...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/dictionary.js"></script>
</head>
<body>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="text" name="tableName" id="s_tableName" class="form-control input-sm">
								</div>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_columnName"><span class="title">列名</span></label>
								<div class="col-xs-8">
									<input type="text" name="columnName" id="s_columnName" class="form-control input-sm">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_tableName" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">表名</span></label>
									<div class="col-xs-8">
										<input type="text" name="tableName" id="e_tableName" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_columnName" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">列名</span></label>
									<div class="col-xs-8">
										<input type="text" name="columnName" id="e_columnName" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-12">
