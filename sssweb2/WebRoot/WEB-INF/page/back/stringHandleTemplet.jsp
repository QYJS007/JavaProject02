...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/stringHandleTemplet.js"></script>
</head>
<body>
			...
			<div class="panel-body">
				<form id="searchform">
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_code"><span class="title">代码</span></label>
								<div class="col-xs-8">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">
						<span class="optmark"></span>字符串处理模板
					</h4>
				</div>
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_code" class="col-xs-2 control-label"><span class="mark">*</span><span class="title">代码</span></label>
									<div class="col-xs-10">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_text" class="col-xs-2 control-label"><span class="title">待处理文本示例</span></label>
									<div class="col-xs-10">
