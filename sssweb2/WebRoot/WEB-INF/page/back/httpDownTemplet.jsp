...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/httpDownTemplet.js"></script>
</head>
<body>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">
						<span class="optmark"></span>http批量下载模板
					</h4>
				</div>
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_url" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">目标链接</span></label>
									<div class="col-xs-8">
										<input type="text" name="url" id="e_url" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label for="e_urlRegex" class="col-xs-2 control-label"><span class="mark">*</span><span class="title">链接正则</span></label>
									<div class="col-xs-10">
										<textarea type="text" name="urlRegex" id="e_urlRegex" class="form-control input-sm" style="height: 80px;"></textarea>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_nameRegex" class="col-xs-4 control-label"><span class="title">名称正则</span></label>
									<div class="col-xs-8">
										<input type="text" name="nameRegex" id="e_nameRegex" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_nextLayer" class="col-xs-4 control-label"><span class="title">作为下一层链接</span></label>
									<div class="col-xs-8">
										<input type="text" name="nextLayer" id="e_nextLayer" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_nextPage" class="col-xs-4 control-label"><span class="title">下一页链接</span></label>
									<div class="col-xs-8">
										<input type="text" name="nextPage" id="e_nextPage" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="col-xs-6">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_intervalTime" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">运行间隔</span></label>
									<div class="col-xs-8">
										<input type="text" name="intervalTime" id="e_intervalTime" class="form-control input-sm">
									</div>
								</div>
							</div>
						</div>
