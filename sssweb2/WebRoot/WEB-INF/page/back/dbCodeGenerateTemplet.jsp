...
<head>
	...
	<script src="${pageContext.request.contextPath}/public/javascripts/back/dbCodeGenerateTemplet.js"></script>
</head>
<body>
			...
			<div class="panel-body">
				<form id="searchform">
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="form-group">
								<label class="col-xs-4 control-label" for="s_type"><span class="title">功能</span></label>
								<div class="col-xs-8">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">
						<span class="optmark"></span>数据库模板代码生成
					</h4>
				</div>
				<div class="modal-body">
					<form id="editform">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label for="e_type" class="col-xs-4 control-label"><span class="mark">*</span><span class="title">功能</span></label>
									<div class="col-xs-8">
