...
var columns = [[
	...
	{field:'type', title:'类型', halign:'center',formatter:function(value,row,index){
			return typeNameValueObj[value];
		}},
	{field:'ip', title:'ip', halign:'center'},
	{field:'port', title:'端口', halign:'center'},
	{field:'username', title:'用户名', halign:'center'},
	{field:'password', title:'密码', halign:'center'},
	{field:'dbname', title:'数据库名称', halign:'center'}

]];

//增删改查的路由
var queryUrl = '/sssweb2/DbInfoBackController/search.do';
var saveUrl = '/sssweb2/DbInfoBackController/save.do';
var deleteUrl = '/sssweb2/DbInfoBackController/delete.do';
