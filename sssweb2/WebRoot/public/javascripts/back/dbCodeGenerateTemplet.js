...
var columns = [[
	...
	{field:'type', title:'功能', halign:'center'},
	{field:'name', title:'模板名称', halign:'center'},
	{field:'code', title:'模板', halign:'center'},
	{field:'param', title:'参数', halign:'center'}

]];

//增删改查的路由
var queryUrl = '/sssweb2/DbCodeGenerateTempletBackController/search.do';
var saveUrl = '/sssweb2/DbCodeGenerateTempletBackController/save.do';
var deleteUrl = '/sssweb2/DbCodeGenerateTempletBackController/delete.do';
