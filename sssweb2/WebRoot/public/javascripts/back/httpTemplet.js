...
var columns = [[
	...
	{field:'url', title:'请求地址', halign:'center'},
	{field:'method', title:'请求方式', halign:'center',formatter:function(value,row,index){
			return methodNameValueObj[value];
		}},
	{field:'head', title:'请求头', halign:'center'},
	{field:'param', title:'请求参数', halign:'center'},
...
//增删改查的路由
var queryUrl = '/sssweb2/HttpTempletBackController/search.do';
var saveUrl = '/sssweb2/HttpTempletBackController/save.do';
var deleteUrl = '/sssweb2/HttpTempletBackController/delete.do';

var methodNameValueObj = {};
...
$(function(){
	...
	//初始化下拉列表
	dictSelect($('#e_method'),'t_http_templet','method',methodNameValueObj);
	dictSelect($('#e_encoding'),'t_http_templet','encoding',encodingNameValueObj);
	...
	$('#modify').click(function(){
		...
		$('#e_name').val(row.name);
		$('#e_url').val(row.url);
		$('#e_method').val(row.method);
		$('#e_head').val(row.head);
		$('#e_param').val(row.param);
