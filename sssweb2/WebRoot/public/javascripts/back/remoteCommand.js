...
var columns = [[
	...
	{field:'func', title:'业务功能', halign:'center'}

]];

//增删改查的路由
var queryUrl = '/sssweb2/RemoteCommandBackController/search.do';
var saveUrl = '/sssweb2/RemoteCommandBackController/save.do';
var deleteUrl = '/sssweb2/RemoteCommandBackController/delete.do';
...
$(function(){
	...
	autocomplete($('#s_commandGroupId'),'remoteCommand_RemoteCommandGroup','id','name');
	autocomplete($('#e_commandGroupId'),'remoteCommand_RemoteCommandGroup','id','name');
