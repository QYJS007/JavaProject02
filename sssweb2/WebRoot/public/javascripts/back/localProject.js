...
var columns = [[
	...
	{field:'packDir', title:'打包文件夹', halign:'center'},
	{field:'packFile', title:'打包文件', halign:'center'}

]];

//增删改查的路由
var queryUrl = '/sssweb2/LocalProjectBackController/search.do';
var saveUrl = '/sssweb2/LocalProjectBackController/save.do';
var deleteUrl = '/sssweb2/LocalProjectBackController/delete.do';
...
$(function(){
	...
	$('#modify').click(function(){
		...
		$('#e_name').val(row.name);
		$('#e_path').val(row.path);
		$('#e_packDir').val(row.packDir);
		$('#e_packFile').val(row.packFile);
